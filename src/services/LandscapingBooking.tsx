...
import landscapingImage from "../imports/Services/popular-landscape.png"
import AddonQuantityStepper from "./AddonQuantityStepper"
import StyleTwoPageHeader from "./StyleTwoPageHeader"

type CategoryId = "grass" | "plants" | "cleanup" | "trees" | "irrigation"
...
const CATEGORIES: Category[] = [
  {
    id: "grass",
    label: "Grass Cutting",
    sub: "Lawn cutting by garden size",
    icon: Plant01Icon,
    tone: P.blue,
    items: [
      { id: "small-lawn", label: "Small lawn", price: 150, unit: "visit" },
      { id: "medium-lawn", label: "Medium lawn", price: 220, unit: "visit" },
      { id: "large-lawn", label: "Large lawn", price: 320, unit: "visit" },
    ],
  },
  {
    id: "plants",
    label: "Hedge / Plant Maintenance",
    sub: "Hedges, shrubs and potted plants",
    icon: Plant02Icon,
    tone: P.blue,
    items: [
      {
      ...
      {
        id: "potted-plants",
        label: "Potted plant maintenance",
        price: 90,
        unit: "visit",
      },
    ],
  },
  {
    ...
    sub: "Leaves, full clean-up and weeds",
    icon: CleanIcon,
    tone: P.green,
    items: [
      {
      ...
      {
        id: "full-cleanup",
        label: "Full garden cleanup",
        price: 220,
        unit: "visit",
      },
      { id: "weed-removal", label: "Weed removal", price: 160, unit: "area" },
    ],
  },
  {
    id: "trees",
    label: "Tree / Outdoor Work",
    sub: "Tree pruning, branches and pressure wash",
    icon: Tree01Icon,
    tone: P.orange,
    items: [
      {
        id: "small-tree-pruning",
        label: "Small tree pruning",
        price: 180,
        unit: "tree",
      },
      {
        id: "branch-cutting",
        label: "Branch cutting",
        price: 120,
        unit: "tree",
      },
      {
        id: "pressure-wash",
        label: "Outdoor pressure wash",
        price: 200,
        unit: "area",
      },
    ],
  },
  {
    ...
    sub: "Irrigation, sprinklers and hose timers",
    icon: WaterPumpIcon,
    tone: P.green,
    items: [
      {
        id: "irrigation-inspection",
        label: "Irrigation inspection",
        price: 140,
        unit: "job",
      },
      {
      ...
      >
        ...
        >
          <img
            ...
            alt="Landscaping and outdoor service"
            style={{
              position: "absolute",
              right: -8,
              top: -8,
        ...
        >
          ...
          >
            ...
            <b style={{ fontSize: 16, fontWeight: 900, color: P.navy }}>
              Reliable landscaping and outdoor service
            </b>
          </div>
          <div style={{ fontSize: 12, lineHeight: 1.5, color: P.gray }}>
            Fixed-price garden maintenance, outdoor clean-up, and irrigation
            checks with verified professionals and transparent prices.
          </div>
        </section>
        <div
          style={{
        ...
        >
          ...
          <div>
            ...
            <div style={{ fontSize: 10, color: P.gray }}>
              Choose the outdoor job that best matches your request
            </div>
          </div>
        </div>
        <PriceTable />
        ...
        >
          ...
          >
            ...
            >
              <I icon={SoilMoistureFieldIcon} size={19} color={P.green} />
              <b
                style={{
                  display: "block",
                  marginTop: 4,
        ...
        >
          ...
          {[
            "Prices apply to normal landed or terrace residential outdoor spaces.",
            "Large trees, specialized arborist work, or heavy machinery are excluded.",
            "Disposal volumes and access conditions may affect pricing.",
...
export default function LandscapingBooking({ onBack, onDone }: Props) {
  const [step, setStep] = useState(0),
    [categoryId, setCategoryId] = useState<CategoryId>("grass"),
      ...
      >
        ...
        >
          ...
          <p style={{ fontSize: 12, color: "#6d8798" }}>
            Your landscaping professional has been notified and your fixed-price
        ...
        <main style={{ flex: 1, padding: 14 }}>
          ...
          >
            ...
            The assigned landscaping professional will arrive at your selected
            time and confirm access, waste volume, and any soil treatment costs.
          </section>
        </main>
  ...
  if (step === 1)
    content = (
      <div style={{ padding: "16px 12px" }}>
        <Title
          title="Choose a landscaping service"
      ...
      <div style={{ padding: "16px 12px" }}>
        ...
        >
          ...
          <textarea
            ...
            placeholder="Describe the garden size, plants, waste, slope, or access details"
            rows={3}
            style={{
              width: "100%",
