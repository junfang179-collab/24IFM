...
import handymanImage from "../imports/Services/popular-handyman.png"
import AddonQuantityStepper from "./AddonQuantityStepper"
import StyleTwoPageHeader from "./StyleTwoPageHeader"

type CategoryId = "furniture" | "door" | "wall" | "mounting" | "repairs"
...
const CATEGORIES: Category[] = [
  {
    ...
    sub: "Small items, medium items and wardrobes",
    icon: Cabinet01Icon,
    tone: P.blue,
    items: [
      { id: "small-item", label: "Small item", price: 55, unit: "job" },
      { id: "medium-item", label: "Medium item", price: 90, unit: "job" },
      {
        id: "large-wardrobe",
  ...
  },
  {
    ...
    sub: "Locks, hinges and door closers",
    icon: DoorLockIcon,
    tone: P.blue,
    items: [
      {
      ...
      {
        id: "door-closer",
        label: "Door closer installation",
        price: 85,
        unit: "unit",
      },
    ],
  ...
  {
    id: "wall",
    label: "Shelf / Wall Installation",
    sub: "Shelves, curtain rods and mirrors",
    icon: DrillIcon,
    tone: P.green,
    items: [
      {
      ...
      { id: "curtain-rod", label: "Curtain rod", price: 70, unit: "set" },
      {
  ...
  {
    id: "mounting",
    label: "TV / Fixture Mounting",
    sub: "TV brackets, frames and bathroom fittings",
    icon: Tv01Icon,
    tone: P.orange,
    items: [
      {
        id: "tv-bracket",
        label: "TV bracket install up to 55 inch",
        price: 100,
        unit: "set",
      },
      {
        id: "picture-frame",
        label: "Picture frame hanging",
        price: 35,
        unit: "piece",
      },
      {
        id: "bathroom-accessory",
        label: "Towel bar / bathroom accessory install",
        price: 45,
        unit: "piece",
      },
    ],
  ...
  {
    id: "repairs",
    label: "Sealing / Small Repairs",
    sub: "Resealing, patching and drawer repairs",
    icon: RepairIcon,
    tone: P.green,
    items: [
      {
        id: "silicone-resealing",
        label: "Silicone resealing",
        price: 45,
        unit: "metre",
      },
      {
        id: "crack-patch",
        label: "Crack patch repair",
        price: 60,
        unit: "area",
      },
      {
        id: "drawer-runner",
        label: "Drawer runner replacement",
        price: 70,
        unit: "set",
      },
    ],
...
const ADDONS = [
  ...
  {
    id: "disposal",
    label: "Extra dismantling / disposal",
    price: 35,
    unit: "item",
    icon: Delete02Icon,
  },
    ...
    >
      ...
      >
        ...
        >
          <img
            src={handymanImage}
            alt="Handyman and repair service"
            style={{
              position: "absolute",
              right: -8,
              top: -8,
          ...
          >
            ...
            >
              ...
              Standard minor repairs and installations
            </div>
          </div>
        </div>
        <section
        ...
        >
          ...
          >
            ...
            <b style={{ fontSize: 16, fontWeight: 900, color: P.navy }}>
              Reliable handyman and repair service
            </b>
          </div>
          <div style={{ fontSize: 12, lineHeight: 1.5, color: P.gray }}>
            Fixed-price home repairs, mounting, assembly, and installation with
            verified professionals and transparent fixed prices.
          </div>
        </section>
        <div
          style={{
        ...
        >
          ...
          <div>
            ...
            <div style={{ fontSize: 10, color: P.gray }}>
              Choose the job that best matches your request
            </div>
          </div>
        </div>
        <PriceTable />
        ...
        >
          ...
          {[
            "Prices apply to standard residential jobs with normal access.",
            "Heavy-duty fixtures or concealed reinforcement may affect price.",
            "Parts and special accessories may be charged separately.",
            "Complex carpentry or custom fabrication needs custom quotation.",
          ].map((n) => (
            <div
              key={n}
              style={{
...
export default function HandymanBooking({ onBack, onDone }: Props) {
  const [step, setStep] = useState(0),
    [categoryId, setCategoryId] = useState<CategoryId>("furniture"),
      ...
      >
        ...
        >
          ...
          <p style={{ fontSize: 12, color: "#6d8798" }}>
            Your handyman has been notified and your fixed-price service is
            scheduled.
          </p>
        </div>
        <main style={{ flex: 1, padding: 14 }}>
          ...
          >
            ...
            The assigned handyman will arrive at your selected time and confirm
            any consumable or special-part costs before work begins.
          </section>
        </main>
  ...
  if (step === 1)
    content = (
      <div style={{ padding: "16px 12px" }}>
        <Title
          title="Choose a handyman service"
      ...
      <div style={{ padding: "16px 12px" }}>
        ...
        >
          ...
          <textarea
            ...
            placeholder="Describe the item, repair, wall type, or access details"
            rows={3}
            style={{
              width: "100%",
