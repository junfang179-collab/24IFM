...
import electricalImage from "../imports/Services/popular-electrical.png"
import AddonQuantityStepper from "./AddonQuantityStepper"
import StyleTwoPageHeader from "./StyleTwoPageHeader"

type CategoryId = "lighting" | "fan" | "socket" | "troubleshooting" | "safety"
...
const CATEGORIES: Category[] = [
  {
    ...
    sub: "Ceiling, pendant and wall lights",
    icon: BulbIcon,
    tone: P.blue,
    items: [
      { id: "ceiling-light", label: "Ceiling Light", price: 70, unit: "point" },
      { id: "pendant-light", label: "Pendant Light", price: 90, unit: "point" },
      { id: "wall-light", label: "Wall Light", price: 75, unit: "point" },
    ],
  },
  {
    id: "fan",
    label: "Fan Installation",
    sub: "Ceiling, exhaust and regulator work",
    icon: Fan01Icon,
    tone: P.blue,
    items: [
      { id: "ceiling-fan", label: "Ceiling Fan", price: 120, unit: "set" },
      { id: "exhaust-fan", label: "Exhaust Fan", price: 85, unit: "set" },
      {
        id: "regulator",
        label: "Replacement Regulator",
        price: 55,
        unit: "unit",
      },
    ],
  },
  {
    id: "socket",
    label: "Socket / Switch",
    sub: "Switch, socket and power outlet work",
    icon: PlugSocketIcon,
    tone: P.green,
    items: [
      {
  ...
  },
  {
    ...
    sub: "Power trips, circuit and doorbell faults",
    icon: ElectricHome01Icon,
    tone: P.orange,
    items: [
      {
        id: "power-trip",
        label: "Power Trip Diagnosis",
        price: 150,
        unit: "job",
      },
      {
        id: "circuit-isolation",
        label: "Faulty Circuit Isolation",
        price: 180,
        unit: "job",
      },
      {
        id: "doorbell",
        label: "Doorbell Troubleshooting",
        price: 70,
        unit: "job",
      },
    ],
  ...
  {
    id: "safety",
    label: "DB / Safety Check",
    sub: "Distribution board and leakage tests",
    icon: CircuitBoardIcon,
    tone: P.green,
    items: [
      { id: "db-check", label: "DB Checking", price: 150, unit: "job" },
      {
        id: "elcb",
        label: "ELCB Test",
        price: 90,
...
const ADDONS = [
  ...
  {
    id: "access",
    label: "Ladder / access difficulty",
    price: 25,
    unit: "area",
    icon: Wrench01Icon,
  },
...
const timeFee = (time: string) =>
  URGENT_TIMES.has(time) ? 40 : AFTER_HOURS_TIMES.has(time) ? 50 : 0
function I({
  icon,
  size = 20,
  color = P.blue,
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            ...
            <b style={{ fontSize: 16, fontWeight: 900, color: P.navy }}>
              Reliable home electrical service
            </b>
          </div>
          <div style={{ fontSize: 12, lineHeight: 1.5, color: P.gray }}>
            Standard home electrical installation, repair, and troubleshooting
            with verified professionals and transparent fixed prices.
          </div>
        </section>
        <div
          style={{
        ...
        >
          ...
          {[
            "Prices cover normal residential access and basic installation.",
            "Decorative fixtures or brand-specific equipment may affect pricing.",
            "Major rewiring or concealed wiring work requires custom quotation.",
            "Power isolation may be needed during service.",
          ].map((n) => (
            <div
              key={n}
              style={{
...
export default function ElectricalBooking({ onBack, onDone }: Props) {
  const [step, setStep] = useState(0),
    [categoryId, setCategoryId] = useState<CategoryId>("lighting"),
      ...
      >
        ...
        >
          ...
          <p style={{ fontSize: 12, color: "#6d8798" }}>
            Your electrician has been notified and your fixed-price service is
            scheduled.
          </p>
        </div>
        <main style={{ flex: 1, padding: 14 }}>
          ...
          >
            ...
            The assigned electrical professional will arrive at your selected
            time and confirm any material costs before work begins.
          </section>
        </main>
  ...
  if (step === 1)
    content = (
      <div style={{ padding: "16px 12px" }}>
        <Title
          title="Choose an electrical service"
        ...
        >
          ...
          >
            ...
            <span style={{ flex: 1, fontSize: 10, color: P.gray }}>
              ...
              >
                Urgent & after-hours arrival
              </b>
              9:00–10:00 + SGD 40 · 19:00–21:30 + SGD 50
            </span>
            <b
              style={{
                flexShrink: 0,
      ...
      <div style={{ padding: "16px 12px" }}>
        ...
        >
          ...
          <textarea
            ...
            placeholder="Describe the fixture, fault or access details"
            rows={3}
            style={{
              width: "100%",
