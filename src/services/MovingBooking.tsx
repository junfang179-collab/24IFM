...
import movingImage from "../imports/Services/popular-moving.png"
import AddonQuantityStepper from "./AddonQuantityStepper"
import StyleTwoPageHeader from "./StyleTwoPageHeader"

type CategoryId = "bulky" | "lorry" | "packing" | "shifting" | "disposal"
type Item = {
  id: string
  label: string
  price: number
...
const CATEGORIES: Category[] = [
  {
    ...
    sub: "Mattresses, sofas and appliances",
    icon: Sofa01Icon,
    tone: P.blue,
    items: [
      { id: "mattress", label: "Mattress", price: 90, unit: "item" },
      { id: "sofa", label: "Sofa", price: 120, unit: "item" },
      {
        id: "fridge-washer",
        label: "Fridge / Washer",
        price: 110,
  ...
  {
    id: "lorry",
    label: "Lorry Moving Service",
    sub: "Half-load, full-load and helpers",
    icon: DeliveryTruck01Icon,
    tone: P.blue,
    items: [
      { id: "half-load", label: "Half-Load", price: 250, unit: "trip" },
      { id: "full-load", label: "Full-Load", price: 450, unit: "trip" },
      {
        id: "helper-addon",
        label: "Helper Add-On",
        price: 0,
        unit: "notes",
        priceLabel: "Covered in notes",
      },
    ],
  },
  {
    ...
    sub: "Packing, unpacking and starter materials",
    icon: Package01Icon,
    tone: P.green,
    items: [
      {
      ...
      {
        id: "unpacking-assistance",
        label: "Unpacking Assistance",
        price: 160,
        unit: "session",
      },
      {
        id: "packing-materials",
        label: "Packing Material Starter Pack",
        price: 45,
        unit: "set",
      },
    ],
  ...
  {
    id: "shifting",
    label: "House Shifting Support",
    sub: "Studio and multi-bedroom moves",
    icon: Home01Icon,
    tone: P.orange,
    items: [
      {
      ...
      {
        id: "two-bedroom",
        label: "2-Bedroom Move",
        price: 650,
        unit: "job",
      },
      { id: "three-bedroom", label: "3-Bedroom Move", price: 920, unit: "job" },
    ],
  },
  {
    id: "disposal",
    label: "Disposal Services",
    sub: "Debris, junk and e-waste pickup",
    icon: Delete02Icon,
    tone: P.green,
    items: [
      {
        id: "renovation-debris",
        label: "Renovation Debris Small Load",
        price: 180,
        unit: "load",
      },
      {
        id: "cardboard-junk",
        label: "Cardboard / Junk Clearance",
        price: 120,
        unit: "load",
      },
      {
...
const timeFee = (time: string) => (URGENT_TIMES.has(time) ? 50 : 0)
function I({
  icon,
  size = 20,
  color = P.blue,
    ...
    >
      ...
      >
        ...
        >
          <img
            src={movingImage}
            alt="Moving and disposal service"
            style={{
              position: "absolute",
              right: -8,
              top: -8,
          ...
          >
            ...
            >
              ...
              Household moving and item disposal
            </div>
          </div>
        </div>
        <section
        ...
        >
          ...
          >
            ...
            <b style={{ fontSize: 16, fontWeight: 900, color: P.navy }}>
              Reliable moving and disposal service
            </b>
          </div>
          <div style={{ fontSize: 12, lineHeight: 1.5, color: P.gray }}>
            Fixed-price moving support, packing assistance, and disposal
            services with verified professionals and transparent prices.
          </div>
        </section>
        <div
          style={{
        ...
        >
          ...
          <div>
            ...
            <div style={{ fontSize: 10, color: P.gray }}>
              Choose the moving or disposal job that best matches your request
            </div>
          </div>
        </div>
        <PriceTable />
        ...
        >
          ...
          >
            ...
            >
              <I icon={Package01Icon} size={19} color={P.green} />
              <b
                style={{
                  display: "block",
                  marginTop: 4,
              ...
              >
                Packing materials and special handling
              </b>
              <b
                style={{
                  display: "block",
        ...
        >
          ...
          {[
            "Prices are for standard residential access and normal item weight.",
            "Disposal is subject to local rules and accepted item types.",
            "Packing materials and dismantling may be additional unless stated.",
            "Large pianos, safes, or specialist equipment require custom quotation.",
          ].map((n) => (
            <div
              key={n}
              style={{
...
export default function MovingBooking({ onBack, onDone }: Props) {
  const [step, setStep] = useState(0),
    [categoryId, setCategoryId] = useState<CategoryId>("bulky"),
  ...
  const category = CATEGORIES.find((c) => c.id === categoryId) ?? CATEGORIES[0],
    ...
    itemsTotal = selectedItems.reduce(
      (s, x) => s + (x.priceLabel ? 0 : x.price * (itemQuantities[x.id] ?? 0)),
      0,
    ),
      ...
      >
        ...
        >
          ...
          <p style={{ fontSize: 12, color: "#6d8798" }}>
            Your moving professional has been notified and your fixed-price
        ...
        <main style={{ flex: 1, padding: 14 }}>
          ...
          >
            ...
            The assigned moving professional will arrive at your selected time
            and confirm access, item volume, and any packing or dismantling
            costs.
          </section>
        </main>
          ...
          {selectedItems.length > 0 && (
            ...
            >
              {selectedItems
                .map(
                  (x) =>
                    `${x.label} ×${itemQuantityFor(x.id)} (${x.priceLabel ?? `SGD ${x.price * itemQuantityFor(x.id)}`})`,
                )
                .join(", ")}
            </div>
          )}
        ...
        >
          ...
          >
            ...
            <span style={{ flex: 1, fontSize: 10, color: P.gray }}>
              ...
              Priority arrival from 9:00–10:00 · + SGD 50 / booking
            </span>
            <b
              style={{
                flexShrink: 0,
          ...
          {date && time && (
            ...
            >
              ...
              {URGENT_TIMES.has(time) ? " · Urgent same-day + SGD 50" : ""}
            </div>
          )}
        </section>
      </div>
      ...
      <div style={{ padding: "16px 12px" }}>
        ...
        >
          ...
          <textarea
            ...
            placeholder="Describe the items, floors, distance, packing, or access details"
            rows={3}
            style={{
              width: "100%",
    ...
    content = (
      <div style={{ padding: "16px 12px" }}>
        ...
        >
          ...
          >
            <span>Packing materials / dismantling</span>
